var slidesetModule = (function() {
    console.log('Loading slidesetModule...');

    // Private Variables.
    var name = 'slidesetModule';
...
which represents the 'weight' the set is to have*/
    ...
    var buildWidget = function(id, txt, qual, value, master, factor) {
        ...
        x.trueCords = function() {
          ...
          */
            //KLUDGE
            x.off = document.getElementById('settingsView').offsetLeft;
    ...
    console.log('- slidesetModule loaded.');
